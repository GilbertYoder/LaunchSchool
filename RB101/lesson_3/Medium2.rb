...
# My Solution
  def tricky_method(a_string_param, an_array_param)
    return {
            ...
            array: an_array_param.push('rutabaga')
          }
  end

  my_string = "pumpkins"
  my_array = ["pumpkins"]
  new_defs = tricky_method(my_string, my_array)

  my_string = new_defs[:string]
  my_array = new_defs[:array]
...
# Their Solution
  ...
  # Takeaway is you can assign multiple variables outside a method return without using a hash!
